...
export function ortho(xMag, yMag, near, far, out = create()) {
    out[0] = 1 / xMag;
    out[1] = 0;
    out[2] = 0;
    out[3] = 0;
...
export function fromRotationTranslationScale(v, q, s, out = create()) {
...
export function lookAt(eye, target, up, out = create()) {
...
;
export function getSubMatrix3(a, out = Mat3Math.create()) {
    out[0] = a[0];
    out[1] = a[1];
    out[2] = a[2];
    out[3] = a[4];
...
//# sourceMappingURL=martix4.js.map